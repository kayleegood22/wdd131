...
function renderRecipes(recipeList) {
    ...
    if (recipeContainer) {
        recipeContainer.innerHTML = recipeTemplate(recipeList); // Only 1 recipe
    } else {
        console.error("Error: Could not find element with class 'recipes' in renderRecipes");
    }
}
...
function init() {
    ...
    if (recipeContainer) {
        ...
        console.error("Error: Could not find element with class 'recipes' in init");
    }
}
...
let searchButton = document.querySelector('.search_row button'); // Corrected button selection
let searchInput = document.querySelector('.search_row input[type="search"]'); // Corrected input selection

searchButton.addEventListener('click', function () {
    let recipeContainer = document.querySelector('.recipes');
    recipeContainer.innerHTML = '';
    let string = searchInput.value.toLowerCase();
